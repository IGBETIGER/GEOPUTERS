...
<div id="main-content">
    <div id="sub_content">
<div class="plan_head"><p>Deposit Transactions</p></div>
...
<tr><td><b>DEPOSIT ID</b></td><td><b>AMOUNT</b></td><td><b>DATE</b></td><td><b>ID</b></td><td><b>DEPOSIT STATUS</b></td></tr>

  <?php 
                   $qry = "select * from deposithistory where id='$session_id' ORDER BY id ASC";
...
<tr><td><?php echo "CBGACV".$row['dep_id']*13; ?></td><td><p style="color: green">+<?php echo $row['currency']. "". number_format($row['amount']); ?></p></td><td><p><?php echo $row['dep_date']; ?></p></td><td><p><?php echo $row['dep_id']*6; ?></p></td><td><p style="color: green"><?php echo $row['dep_status']; ?></p></td></tr>
                                    <?php } ?>
